...
<b>/new_raffle <i>"texto del sorteo" "número de participantes"</i></b> - I\'ll start a raffle.<br><b>NOTE</b>: if you want to cancel any of this you can use the <b><i>/cancel_event</i>/b> or <b><i>/cancel_raffle</i>/b>''',
